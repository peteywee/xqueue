...
-- A missing authority_state is fail-closed and must not fabricate current ownership.
-- Production activation requires a separately evidenced ownership transition.
