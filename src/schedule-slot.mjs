...
function candidateOffsets(targetWallMs, timeZone) {
  ...
  // Sample far enough around the requested local date to discover both sides
  // of a DST transition without guessing one occurrence.
...
export function resolveUniqueWallClock({
  ...
  // Intl throws RangeError for an unsupported IANA zone.
  formatter(timezone);
